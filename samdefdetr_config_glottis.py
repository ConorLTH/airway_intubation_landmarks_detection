...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        classes=classes,
        ann_file='/media/ren3/disk2_hdd1/tianhang/Bnasals/train.json',
        img_prefix='/media/ren3/disk2_hdd1/tianhang/Bnasals/'),
    val=dict(
        type=dataset_type,
        classes=classes,
        ann_file='/media/ren3/disk2_hdd1/tianhang/Bnasals/val.json',
        img_prefix='/media/ren3/disk2_hdd1/tianhang/Bnasals/'),
    test=dict(
        type=dataset_type,
        classes=classes,
        ann_file='/media/ren3/disk2_hdd1/tianhang/Bnasals/test/test.json',
        img_prefix='/media/ren3/disk2_hdd1/tianhang/Bnasals_robustness/zoom_blur/1'))
